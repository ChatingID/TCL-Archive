...
# Bind Help All SC
bind pub m !bothelp pub_helpall
bind msg m bothelp msg_helpall

proc pub_helpall {nick chan uhost hand rest} {
	putserv "NOTICE $nick :Help Comand: chanhelp, cadelhelp, conshelp, dtbshelp, mischelp"
}
proc msg_helpall {nick uhost hand rest} {
	putserv "NOTICE $nick :Help Comand: chanhelp, cadelhelp, conshelp, dtbshelp, mischelp"
}
